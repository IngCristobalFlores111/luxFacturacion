...
var init_data = [];
    $scope.facturas = [];
    $scope.filtros = {UUID:"",fechaDesde:"",fechaHasta:"",montoDesde:0,montoHasta:0,q:""};
    $scope.clearForm = function(){
        $scope.filtros = {UUID:"",fechaDesde:"",fechaHasta:"",montoDesde:0,montoHasta:0,q:""};

    }
    foliosService.getInitFacturas().then(function(resp){
        var data = resp.data;
$scope.facturas = data;
init_data = angular.copy(data);
    ...
    $scope.search = function(){
      ...
      foliosService.search(filtros).then(function(resp){
    ...
    $scope.mostratGuardadas = function(){
        ...
        foliosService.getPendings().then(function(resp){
