...
$idSucursal = MysqlLink::m_filterInput($_POST["ID_SUCURSAL"]);

$sql = "DELETE FROM `usuarios_expedicion` WHERE `idusuario` = '".$idUsuario."' AND `idexpedicion` = '".$idSucursal."'";
$ret = $link->m_SendCommand($sql,MysqlLink::NAMED,MysqlLink::RET_NO);
