...
$pdf->Cell(111,4,'Descripción',0,0,'C',true);
...
//Cambiar el retorno de carro de descripción, ya que el espacio dedicado a dicha
//información será reducida
...
//Como se llama la variable de sesión -- Preview
...
function generateFacturaPreview($factura_paramas,$idCliente,$LogoPath,$Code2DPath,$OutputFileName,$EmitterEmail,$EmitterPhone,$ReceptorEmail,$ReceptorPhone)
{
	...
	for($Pages = 0; $Pages < $TotalPages; $Pages++)
	{
		...
		$pdf->SetFont('Arial','',8);
		$pdf->SetXY(44,15);
		$pdf->Cell(116,5,'Colonia:'.utf8_decode($Factura["EmisorDomicilioColonia"]). ' C.P :'.$Factura["EmisorDomicilioCP"].' ',0,0,'C');
		...
		$pdf->SetFont('Arial','',8);
		$pdf->SetXY(44,30);
		$pdf->Cell(116,5,'Lugar de Expedición: '.utf8_decode($Factura["LugarExpedicion"]),0,0,'C');
