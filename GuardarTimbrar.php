        ...
        $("#i_btnContinuar").click(function () {
            if ($("#i_radioGyT").prop("checked"))
            {
                ...
                var no_cuneta = "<?php echo $_POST['noCuenta']; ?>";
                        ...
                        $.post("Facturacion/facturarCliente.php", { noCuenta: no_cuneta, idExpedicion: idLugarExp, idCliente: idCliente, factura_params: fp }, function (data) {
                 console.log(data.toString().trim());
     var lj_respuesta = $.parseJSON(data.toString().trim());
                            $("#i_goOn").show();
                            $("#i_btnContinuar").remove();
