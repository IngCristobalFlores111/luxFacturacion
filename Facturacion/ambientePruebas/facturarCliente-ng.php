...
(`folio_factura`, `folio_impreso`, `idcliente`, `enviado`,
 `xml_file`, `montoTotal`, `uuid`, `fecha_timbrado`,
  `fecha_cancelada`, `tipo`, `json_conceptos`) VALUES ('$folio','$folio','".$request['idCliente']."',
...
generatePdf("https://www.luxline.com.mx/joseO/LuxFacturacion/Facturacion/ambientePruebas/facturas/timbradas/xml/".$xml_file,"golman.badger@gmail.com",$EmitterPhone,"https://www.luxline.com.mx/joseO/LuxFacturacion/Facturacion/ambientePruebas/facturas/timbradas/xml/".$qr,$absolutePdf);
